...
return (
  <div className="min-h-screen flex items-center justify-center bg-[#0f172a] p-4">
    ...
    <div className="w-full max-w-md rounded-2xl overflow-hidden shadow-2xl border border-gray-700">
      ...
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-600 via-indigo-500 to-pink-500 p-6 text-center">
        <h1 className="text-3xl font-bold text-white">⚡ CodeForge</h1>
        <p className="text-gray-200 mt-2">Think. Solve. Master.</p>
      </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div>
            ...
            <input
              type="text"
              placeholder="John"
              className={`w-full mt-1 px-4 py-3 rounded-lg bg-[#1e293b] text-white border ${
          ...
          <div>
            ...
            <div className="relative">
              <input
                type={showPassword ? "text" : "password"}
                placeholder="••••••••"
                className={`w-full mt-1 px-4 py-3 rounded-lg bg-[#1e293b] text-white border pr-10 ${
